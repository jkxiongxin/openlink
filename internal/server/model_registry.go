...
var browserModelRegistry = []browserModelSpec{
	...
	{ID: "claude-web/claude-sonnet-4-6", SiteID: "claude", Capability: modelCapabilityText, Description: "Claude web text chat via browser automation"},
	{ID: "kimi-web/moonshot-v1-32k", SiteID: "kimi", Capability: modelCapabilityText, Description: "Kimi web text chat via browser automation"},
	{ID: "perplexity-web/perplexity-web", SiteID: "perplexity", Capability: modelCapabilityText, Description: "Perplexity web text chat via browser automation"},
	{ID: "glm-intl-web/glm-4-plus", SiteID: "glm-intl", Capability: modelCapabilityText, Description: "GLM International web text chat via browser automation"},
